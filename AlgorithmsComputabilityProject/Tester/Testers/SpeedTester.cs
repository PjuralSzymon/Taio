...
namespace AlgorithmsComputabilityProject.Tester
{
    public static class SpeedTester
    {
        ...
        // ------------- RANDOMIZED METHODS -------------
        public static Dictionary<string, List<double>> RunSpeedTestsForExactAlgorithms(int minSize, int maxSize, int numberOfMatrices = 10)
        {
            Console.WriteLine("SPEED TESTS FOR EXACT ALGORITHMS START");
            ...
            RunTestsAndSaveMeanResults(timings, minSize, maxSize, numberOfMatrices);
        ...
        public static Dictionary<string, List<double>> RunSpeedTestsForApproximateAlgorithms(int minSize, int maxSize, int numberOfMatrices = 10)
        {
            Console.WriteLine("SPEED TESTS FOR APPROXIMATE ALGORITHMS START");
        ...
        private static void RunTestsAndSaveMeanResults(Dictionary<string, List<double>> timings, int minSize, int maxSize, int numberOfMatrices = 10)
        {
            Stopwatch stopwatch = new Stopwatch();
